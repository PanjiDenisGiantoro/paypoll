                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Pinjaman Lain Karyawan</li>
                                        </ul>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <table  width="900px">
                                    	<tr>
                                    		<td>
	                                    	<div class="form-group">
	                                            <label for="IdLain" class=" form-control-label">Id Pinjaman Lain</label>
	                                            <input type="text" id="IdLain" placeholder="Masukkan ID Pinjaman Lain" class="form-control"style="width: 400px">
                                        	</div>
                                        ...
                                        <tr>
                                        	<td>
	                                    	<div class="form-group">
	                                            <label for="tgl_pinjam_lain" class=" form-control-label">Tanggal Pinjam lain</label>
	                                            <input type="text" id="tgl_pinjam_lain"  placeholder="Masukkan Tanggal Pinjam Lain" class="form-control"style="width: 400px" >
	                                               
                                        	</div>
                                        </td>
                                        	<td>
	                                    	<div class="form-group">
	                                            <label for="jumlah" class=" form-control-label">Jumlah Pinjam Lain</label>
	                                            <input type="text" id="jumlah"  placeholder="Masukkan Pinjam Lain Lain" class="form-control"style="width: 400px" >
