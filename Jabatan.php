                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Jabatan Karyawan</li>
                                        </ul>
                                    </div>
                                    ...
                                    <table  width="900px">
                                    	<tr>
	                                    	...
	                                    	<div class="form-group">
	                                            ...
	                                            <input type="text" id="Id_Jabatan" placeholder="Masukkan ID Jabatan" class="form-control"style="width: 400px">
                                        	</div>
                                        ...
                                        <tr>
                                        	<td>
	                                    	<div class="form-group">
	                                            <label for="Nama_jabatandatepicker" class=" form-control-label">Nama Jabatan</label>
	                                            <input type="text" id="Nama_jabatan"  placeholder="Masukkan Nama Jabatan Anda" class="form-control"style="width: 400px" >
