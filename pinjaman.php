                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Pinjaman Karyawan</li>
                                        </ul>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <table  width="900px">
                                    	<tr>
                                    		<td>
	                                    	<div class="form-group">
	                                            <label for="Id_Pinjaman" class=" form-control-label">Id Pinjaman</label>
	                                            <input type="text" id="Id_Pinjaman" placeholder="Masukkan ID Pinjaman" class="form-control"style="width: 400px">
                                        	</div>
                                        ...
                                        <tr>
                                        	<td>
	                                    	<div class="form-group">
	                                            <label for="Jumlah_pinjam" class=" form-control-label">Jumlah Pinjam</label>
	                                            <input type="text" id="Jumlah_pinjam"  placeholder="Masukkan Jumlah Pinjam" class="form-control"style="width: 400px" >
	                                               
                                        	</div>
                                        </td>
                                   		<td>
	                                    	<div class="form-group">
	                                            <label for="Sisa_pinjam" class=" form-control-label">Sisa pinjam</label>
	                                            <input type="text" id="Sisa_pinjam"  placeholder="Masukkan Sisa Pinjam" class="form-control"style="width: 400px" >
                                        ...
                                        <tr>
	                                    	...
	                                    	<div class="form-group">
	                                            ...
	                                            <input type="text" id="Tanggal_Pinjam"  placeholder="Masukkan Tanggal Pinjam" class="form-control"style="width: 400px" >
